/* learn-economics-with-phoebe - shared page behavior
...
(function () {
  ...
  if (crumb && mastheadWrap) {
    var LEADER_PAGES = ["a1-prices-are-information.html", "a2-incentives-and-elasticity.html", "a3-marginal-thinking.html", "a4-when-markets-fail.html", "a5-money-inflation-and-interest.html", "a6-games-and-moats.html"];
    var BUILDER_PAGES = ["p1-demand-from-data.html", "p2-why-the-naive-number-lies.html", "p3-pricing-with-the-number.html", "p4-the-economics-of-a-prediction.html", "p5-network-effects-and-data-moats.html", "p6-auctions.html", "p7-labour-economics-of-ai.html", "p8-information-economics-of-models.html", "p9-build-buy-or-rent.html", "p10-the-elasticity-bench.html"];
    var ml = crumb.textContent.match(/Foundations session (\d+) of 6/);
    var mb = crumb.textContent.match(/Deep-dive session (\d+) of 10/);
    var m = ml || mb;
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = ml ? LEADER_PAGES : BUILDER_PAGES;
      var letter = ml ? "Foundations session " : "Deep-dive session ";
      var journey = document.createElement("div");
      journey.className = "journey";
      var jl = document.createElement("span");
      jl.className = "jlabel";
      jl.textContent = ml ? "Foundations track" : "Data and AI deep-dive track";
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:economics";
  var TOTAL_SESSIONS = 16;
  var SESSION_KEYS = ["a1", "a2", "a3", "a4", "a5", "a6", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10"];
  var SESSION_LABELS = ["F1", "F2", "F3", "F4", "F5", "F6", "D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10"];
  ...
  document.querySelectorAll(".scorecard").forEach(function (sc) {
    ...
    /* Coaching lines default to the halfway grade. A final scorecard overrides them
  ...
  var cmA = crumbEl && crumbEl.textContent.match(/Foundations session (\d+) of 6/);
  var cmB = crumbEl && crumbEl.textContent.match(/Deep-dive session (\d+) of 10/);
  var here = cmA ? "a" + cmA[1] : (cmB ? "p" + cmB[1] : null);
  var hereLabel = cmA ? "Foundations session " + cmA[1] : (cmB ? "Deep-dive session " + cmB[1] : "");
