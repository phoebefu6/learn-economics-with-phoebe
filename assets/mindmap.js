...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#1F3A5F");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#1F3A5F");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#C5D3E6");   // concept border
  var C_TINT   = theme("--indigo-50", "#EEF2F8");     // concept fill
  var C_INK    = theme("--ink", "#142944");           // concept text
  var C_FAINT  = theme("--faint", "#DCE3EE");         // twig edges
